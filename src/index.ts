...
export { default as PrimitiveTypeAbstraction } from "./abstractions/types/PrimitiveTypeAbstraction";

export { TypeScriptClass, TypescriptMethod } from "./prefabs/sintaxes/typescript/TSClass";
export { TypescriptConstrains, TypescriptFile, TypescriptPackage } from "./prefabs/sintaxes/typescript/TSProject";
export { TypescriptSintaxe } from "./prefabs/sintaxes/typescript/TSSintaxe";
export {
  TypescriptBigInt,
  TypescriptBoolean,
  TypescriptNull,
